...
export function SunDialLogo({ onClick }: SunDialLogoProps) {
  return (
    ...
    >
      <div
        className="mb-2 md:mb-4 h-9 w-9 rounded-full bg-accent shadow-[0_0_30px_var(--color-glow-strong),0_0_60px_var(--color-glow)] transition-all duration-300 group-hover:bg-accent-text group-hover:shadow-[0_0_45px_var(--color-glow-strong),0_0_90px_var(--color-glow)]"
      />

...
describe('resolver', () => {
  ...
  describe('US states', () => {
    it('resolves california', () => {
      ...
      expect(result?.primary.method).toBe('state')
    })
  ...
  describe('timezone abbreviations', () => {
    it('resolves est', () => {
      ...
      expect(result?.primary.iana).toBe('America/New_York')
      expect(result?.primary.method).toBe('abbreviation')
  ...
  describe('fuzzy matching', () => {
    it('matches "Londno" (typo) to London', () => {
      ...
      expect(result?.primary.city).toBe('London')
      expect(result?.primary.method).toBe('fuzzy')
    })
    ...
    it('matches "Sydnee" (typo) to Sydney', () => {
      ...
      expect(result?.primary.city).toBe('Sydney')
      expect(result?.primary.method).toBe('fuzzy')
    })
  })
  ...
  describe('disambiguation', () => {
    it('resolves Portland with primary (OR) and alternatives', () => {
      ...
      expect(result?.primary.city).toBe('Portland')
      expect(result?.primary.iana).toBe('America/Los_Angeles')
    ...
    it('resolves Cambridge with alternatives', () => {
      ...
      expect(result?.primary.city).toBe('Cambridge')
    })

    it('resolves Geneva with alternatives', () => {
      const result = resolveLocation('Geneva')
      expect(result).not.toBeNull()
      expect(result?.primary.city).toBe('Geneva')
    })
  })
  ...
  describe('edge cases', () => {
    ...
    it('abbreviation city field is uppercase', () => {
      const result = resolveLocation('est')
      expect(result?.primary.city).toBe('EST')
    })
